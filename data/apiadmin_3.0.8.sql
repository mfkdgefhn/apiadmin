...
CREATE TABLE `admin_group` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL DEFAULT '' COMMENT '组名称',
  `apiName` varchar(255) NOT NULL COMMENT '所属接口名字',
  `description` text DEFAULT NULL COMMENT '组说明',
  `status` tinyint(2) NOT NULL DEFAULT 1 COMMENT '组状态',
...
CREATE TABLE `admin_list` (
  ...
  `sql` blob NOT NULL DEFAULT '' COMMENT '当前接口所属的sql语句',
  PRIMARY KEY (`id`),
...
VALUES
	(1,'root','root','912601e4ad1b308c9ae41877cf6ca754',1519453594,2130706432,1524152828,1,NULL);
