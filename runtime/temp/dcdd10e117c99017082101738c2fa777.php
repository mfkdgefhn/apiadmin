<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\PHPTutorial\WWW\ApiAdmin\public/../application/wiki\view\index\detail.html";i:1548313180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="ui container">
    ...
    <?php $http_type = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ||
    (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https')) ? 'https://' :
    'http://'; ?>
    <div class="ui teal big message" id="msg">
        接口访问地址：<?php echo $http_type; ?><?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo $groupInfo['apiName']; ?>/<?php echo $hash; ?>
    </div>
    <div class="ui grid">
        <div class="four wide column">
            <div class="ui vertical menu" style="width: 100%;overflow: auto;">
                ...
                href="<?php echo url('/wiki/detail/'.$groupHash.'/'.$vo["hash"]); ?>">
                <?php echo mb_substr($vo['info'], 0, 11); ?>...
                <div class="ui <?php if($hash== $vo[
                'hash']): ?>teal<?php endif; ?> label"> &gt;
            </div>
            </a>
    ...
    <div class="twelve wide column">
        <div class="ui floating message" id="detail" style="overflow: auto;">
            <h2 class='ui header'>接口唯一标识：<a target="_blank"
                                            href="<?php echo $http_type; ?><?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo $groupInfo['apiName']; ?>/<?php echo $hash; ?>"><?php echo $hash; ?></a><?php if($detail['isTest'] == 1): ?>（<?php echo $detail['apiClass']; ?>）<?php endif; ?></h2><br/>
            <div class="ui raised segment">
                ...
                <?php endif; endif; ?>
                <span class="ui teal label large"><i
                        class="certificate icon"></i><?php echo config('apiAdmin.APP_VERSION'); ?></span>
            ...
            <div class="ui tab segment active" data-tab="first">
                ...
                <table class="ui red celled striped table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['isMust']==1?'<span class="ui green label">必填</span>':'<span
                                class="ui teal label">可选</span>'; ?>
                        </td>
            ...
            <p>&copy; Powered By <a href="http://www.apiadmin.org/" target="_blank"><?php echo config('apiAdmin.APP_NAME'); ?>
                <?php echo config('apiAdmin.APP_VERSION'); ?></a>
            <p>
        </div>
    </div>
</div>
